    ...
    if(mavlink_parse_char(MAVLINK_COMM_0, c, &msg, &status)) {
      switch(msg.msgid) {
        ...
        case MAVLINK_MSG_ID_SYS_STATUS : 
          ...
          batteryVoltage = mav.battery_voltage; 
          break;
        ...
        case MAVLINK_MSG_ID_RC_CHANNELS_RAW: 
          mav.chan7_raw = mavlink_msg_rc_channels_raw_get_chan7_raw(&msg);
          mav.chan3_raw = mavlink_msg_rc_channels_raw_get_chan3_raw(&msg);
          rcThrottle = mav.chan3_raw;
          ledSwitch = mav.chan7_raw;
          //add_timestamp(TIMESTAMP_MAVLINK_MSG_ID_RC_CHANNELS_SCALED);
